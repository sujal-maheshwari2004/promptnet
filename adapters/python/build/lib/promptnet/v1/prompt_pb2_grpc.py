...
class PromptServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.ListPrompts = channel.unary_unary(
                '/promptnet.v1.PromptService/ListPrompts',
                request_serializer=promptnet_dot_v1_dot_prompt__pb2.ListPromptsRequest.SerializeToString,
                response_deserializer=promptnet_dot_v1_dot_prompt__pb2.ListPromptsResponse.FromString,
                _registered_method=True)
...
def add_PromptServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListPrompts': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=promptnet_dot_v1_dot_prompt__pb2.ListPromptsRequest.FromString,
                    response_serializer=promptnet_dot_v1_dot_prompt__pb2.ListPromptsResponse.SerializeToString,
            ),
    }
...
class PromptService:
    ...
    def ListPrompts(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/promptnet.v1.PromptService/ListPrompts',
            promptnet_dot_v1_dot_prompt__pb2.ListPromptsRequest.SerializeToString,
            promptnet_dot_v1_dot_prompt__pb2.ListPromptsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
